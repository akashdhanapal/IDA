            ...
            <footer className="footer-distributed">
                ...
                <div className="footer-center">
                    ...
                    <div>
                        ...
                        <p>INDUSTRIAL DESIGN &amp; ANIMATIONS<br />Karunaa Conclave,<br /><span>No.1963, J Block, 3rd Street, 5th Main Road,</span> Anna Nagar West, Anna Nagar, Chennai,<br />Tamil Nadu - 600040, INDIA</p>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <p>E mail: <br/><a href="#">info@idacreations.com</a></p>
                    </div>
                </div>
                ...
                <div className="footer-right">
                    ...
                    <p className="footer-company-about">
                        <span>About the design Animation for e-commerce</span>
                        Join Us into the Immersive Future and achieving success.
                    </p>
                    ...
                    <div className="footer-icons">
                        ...
                        </svg><i className="fa fa-twitter"></i></a>
                        ...
                        </svg><i className="fa fa-linkedin"></i></a>
                        ...
                        </svg><i className="fa fa-github"></i></a>
